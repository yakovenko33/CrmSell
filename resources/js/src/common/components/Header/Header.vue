...
<!--                                    <img src="assets/images/user.png" alt="user profile">-->
                                ...
                                <ul class="dropdown-menu" aria-labelledby="user-dropdown-toggle">
                                    ...
                                    <li v-if="hasRoles([rolesEnum.ADMIN])">
...
const AdminSidepanel = defineAsyncComponent(() => import('@/js/src/common/components/Header/Sidepanel/AdminSidepanel.vue'));
const AppSidepanel = defineAsyncComponent(() => import('@/js/src/common/components/Header/Sidepanel/AppSidepanel.vue'));
...
export default defineComponent({
    ...
    created() {
        this.sidepanel = this.$route.meta.sidepanel;
    },
    methods: {
        logout(): void {
            axios.post('/logout')
