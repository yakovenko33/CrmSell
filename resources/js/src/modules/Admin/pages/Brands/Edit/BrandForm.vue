...
export default defineComponent({
    ...
    methods: {
        getStatus(): void {
            axios.get('/api/v1/brand/' + this.recordId).then((response) => {
        ...
        create(): void {
            this.isLoading = true;
            axios.post('/api/v1/brand', this.form).then(async (response) => {
        ...
        update(): void {
            ...
            axios.put('/api/v1/brand', this.form).then(async (response) => {
