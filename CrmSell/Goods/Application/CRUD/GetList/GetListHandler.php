...
namespace CrmSell\Goods\Application\CRUD\GetList;
...
class GetListHandler extends AbstractHandler
{
    ...
    public function __construct(
        ...
        GoodsRepositoryInterface $repository
    ) {
        parent::__construct();
    ...
    {
        $this->pagination
            ->setAmount($this->repository->getCount())
        ...
        $this->resultHandler
            ->setStatusCode()
            ->setResult([
                "records" => $this->repository->getList($dto)->toArray(),
